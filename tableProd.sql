...
CREATE TABLE IF NOT EXISTS "productsToOrders"(
   "productsId" int REFERENCES "products"("id"),
   "orderId" bigint REFERENCES "orders"("id"),
   "quantity" smallint NOT NULL DEFAULT 1,
   PRIMARY KEY("productsId", "orderId")
);
   INSERT INTO "productsToOrders" ("productsId","orderId","quantity")
   VALUES(1,1,20),(2,1,1),(1,2,10),(1,3,10);